...
class Model:
    def __init__(self, model_path):
        ...
        self.model_args, self.data_args, self.training_args = parser.parse_json_file(json_file='/app/src/title_generator/config.json')
...
model = Model('/app/model/checkpoint-8500')
def get_model():
    return model
